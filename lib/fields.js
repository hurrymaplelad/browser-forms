...
attachableField.attach = function (attachedWidget, formOptions) {
  var options = {};
  var field = this;
  if(options) {
    options = mix(ATTACH_DEFAULTS, formOptions);
  } else {
...
attachedField.showError = function (message) {
  this.error = message;
  if (this.fieldElement && this.errorMessageElement) {
